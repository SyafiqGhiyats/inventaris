...
<head>
	...
	<?php if (!empty($plugin_styles)) : ?>
		...
		<?php foreach ($plugin_styles as $style) : ?>
			<link href="<?= base_url() ?>assets/admin/non-angular/<?= $style ?>" rel="stylesheet" type="text/css" />
		<?php endforeach; ?>
		...
		<section id="header">
			<header class="clearfix" style="background-color: #000000;">
				...
				<ul class="nav-right pull-right list-inline">
					...
					<li class="dropdown nav-profile" style="margin-top: 10px;">
						<span style="color: white;"><?=$this->session->userdata('nama')?> (<?=$this->session->userdata('level')?>)</span>
					</li>
				</ul>
